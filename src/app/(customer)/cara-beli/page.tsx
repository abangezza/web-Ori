  ...
  const buyingSteps = [
    {
      ...
      description:
        "Calon pembeli dapat melihat daftar unit mobil atau motor yang tersedia pada website resmi Radja Auto Car. Filter berdasarkan merek, harga, tahun, dan spesifikasi yang diinginkan.",
      icon: Search,
      color: "bg-blue-500",
      features: [
    ...
    },
    {
      ...
      description:
        "Calon pembeli melakukan negosiasi kredit/cash dengan Admin showroom. Tim profesional kami siap membantu mencarikan solusi pembiayaan terbaik sesuai kemampuan Anda.",
      icon: Calendar,
      color: "bg-orange-500",
      features: [
      ...
      actionLink:
        "https://wa.me/628111110067?text=Halo, saya ingin konsultasi pembelian mobil",
    },
    {
      id: 3,
      ...
      description:
        "Calon pembeli melakukan pembayaran jika harga yang di ajukan sudah sesuai dan sudah terkonfirmasi oleh pihak showroom. Proses pembayaran dapat dilakukan secara cash atau kredit.",
      icon: CreditCard,
      color: "bg-green-500",
      features: [
    ...
    },
    {
      ...
      description:
        "Pembeli mendapatkan bukti/kuitansi pembelian dari pihak showroom. Proses balik nama, pengurusan STNK, dan dokumen legal lainnya ditangani profesional.",
      icon: FileText,
      color: "bg-purple-500",
      features: [
    ...
    },
    {
      ...
      description:
        "Customer menerima unit yang di beli. Pihak showroom mengantarkan unit langsung ke rumah customer atau customer bisa langsung datang ke showroom untuk mengambil unit yang sudah dilunas.",
      icon: Car,
      color: "bg-indigo-500",
      features: [
      ...
      action: "Hubungi Kami",
      actionLink:
        "https://wa.me/628111110067?text=Halo, saya ingin informasi pengantaran kendaraan",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Ya, kami bekerja sama dengan berbagai bank dan leasing untuk memberikan pilihan kredit terbaik. DP mulai dari 20% dengan tenor hingga 5 tahun.",
    },
    {
      question: "Berapa lama proses kredit disetujui?",
      answer:
        "Proses approval kredit biasanya 1-3 hari kerja, tergantung kelengkapan dokumen dan bank yang dipilih.",
    },
    {
      question: "Apakah ada garansi untuk mobil bekas?",
      answer:
        "Ya, semua mobil bekas kami telah melalui inspeksi menyeluruh dan diberikan garansi mesin selama 3 bulan.",
    },
    {
      question: "Bisakah melakukan test drive sebelum membeli?",
      answer:
        "Tentu saja! Kami sangat menganjurkan test drive untuk memastikan kenyamanan dan performa kendaraan.",
    },
    {
      question: "Bagaimana dengan after-sales service?",
      answer:
        "Kami menyediakan layanan after-sales termasuk service berkala, spare part original, dan konsultasi teknis.",
    },
  ];
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Sebelum membeli unit, peserta diwajibkan membaca dan memahami
            peraturan dan cara pembelian.
          </p>
          <div className="mt-8">
            <a
              href="#steps"
            ...
            <div className="relative">
              ...
              <div className="absolute top-20 left-0 right-0 h-1 bg-gray-300">
                <div
                  ...
                  style={{
                    width: `${(activeStep / (buyingSteps.length - 1)) * 100}%`,
                  }}
                ></div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    <div
                      className={`inline-flex items-center px-4 py-2 rounded-full text-white text-sm font-medium mb-4 ${buyingSteps[activeStep].color}`}
                    >
                  ...
                  <div>
                    <ul className="space-y-3">
                      {buyingSteps[activeStep].features.map(
                        (feature, index) => (
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Siap Membeli Mobil Impian?
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Tim profesional kami siap membantu Anda menemukan mobil yang tepat
            dengan proses yang mudah dan aman.
          </p>
