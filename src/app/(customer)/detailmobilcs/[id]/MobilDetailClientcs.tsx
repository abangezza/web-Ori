  ...
  const handleInputChange = (field: string, value: string) => {
    ...
    if (field === "dp") {
      ...
      if (value && dpValue < data.dp) {
        newErrors.dp = `DP Minimal Mobil Ini Adalah Rp.${data.dp.toLocaleString(
          "id-ID"
        )}`;
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder={`*Dp Minimal ${(data.dp || 0).toLocaleString(
                        "id-ID"
                      )} Rupiah`}
                      value={formData.dp}
                      onChange={(e) => {
                ...
                <div>
                  ...
                  <input
                    ...
                    value={
                      formData.angsuran
                        ? `Rp.${parseInt(formData.angsuran).toLocaleString(
                            "id-ID"
                          )}`
                        : ""
                    }
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleTestDriveInputChange("nama", e.target.value)
                    }
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleCashInputChange("nama", e.target.value)
                    }
