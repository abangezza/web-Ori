                ...
                <div className="flex h-20 items-center justify-between">
                    ...
                    <div className="flex items-center flex-shrink-0" style={{ marginLeft: '120px' }}>
                        <div className="relative mr-4">
                            ...
                            <div className="bg-black rounded-full flex items-center justify-center" style={{ width: '48px', height: '48px' }}>
                                <Image
                        ...
                        <span className={`font-bold transition-colors duration-300 font-serif ${
                            isHomePage 
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden" id="mobile-menu">
                    <div className={`px-2 pt-2 pb-3 space-y-1 ${
                        isHomePage
                            ? (isScrolled ? 'bg-white shadow-lg' : 'bg-black bg-opacity-80 backdrop-blur-sm')
