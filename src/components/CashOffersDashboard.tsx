...
const CashOffersDashboard = () => {
  ...
  const [selectedOffer, setSelectedOffer] = useState<CashOfferWithMobil | null>(null);
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.averageDiscount}%</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">{stats.byDiscountRange["0-3%"]}</div>
                <div className="text-sm text-gray-600">0-3% Discount</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-yellow-600">{stats.byDiscountRange["3-6%"]}</div>
                <div className="text-sm text-gray-600">3-6% Discount</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-600">{stats.byDiscountRange["6-9%"]}</div>
                <div className="text-sm text-gray-600">6-9% Discount</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-red-600">{stats.byDiscountRange[">9%"]}</div>
                ...
                <tr key={offer._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      <div className={`text-sm font-medium ${getDiscountColor(offer.persentaseDiskon)}`}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className={`inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(offer.status)}`}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex items-center gap-2">
                      ...
                      {offer.status === 'pending' && (
                        <>
                          <button
                            onClick={() => updateOfferStatus(offer.mobil._id, offer._id, 'accepted')}
                          ...
                          <button
                            onClick={() => updateOfferStatus(offer.mobil._id, offer._id, 'rejected')}
                      ...
                      <a
                        href={`https://wa.me/${offer.customerPhone.replace(/\D/g, '')}`}
                        target="_blank"
            ...
            <div className="text-center py-12">
              {searchTerm ? (
                ...
                <>
                  ...
                  <h3 className="text-xl font-semibold text-gray-700 mb-2">
                    {statusFilter === 'pending' ? 'Belum Ada Pending Offers' : 'Belum Ada Offers'}
                  </h3>
...
const OfferDetailModal = ({
  ...
  onClose: () => void;
  onUpdateStatus: (mobilId: string, offerId: string, status: 'accepted' | 'rejected', notes?: string) => void;
}) => {
  const [notes, setNotes] = useState(offer.notes || "");
  const [newStatus, setNewStatus] = useState<'accepted' | 'rejected'>('accepted');
      ...
      <div className="bg-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-gray-900">Cash Offer Detail</h2>
            <button
              onClick={onClose}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-sm font-medium text-gray-600">Harga Tawaran</label>
                  ...
                  <div>
                    ...
                    <p className={`text-lg font-bold ${getDiscountColor(offer.persentaseDiskon)}`}>
                      -{offer.persentaseDiskon}%
                    </p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Selisih Harga</label>
                    <p className="text-red-600 font-medium">
                      -{formatCurrency(offer.selisihHarga)}
                    </p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Tanggal Offer</label>
                    <p className="text-gray-900">{formatDate(offer.timestamp)}</p>
                  </div>
                  <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-sm font-medium text-gray-600">Mobil</label>
                    <p className="text-gray-900">
                      {offer.mobil.merek} {offer.mobil.tipe} ({offer.mobil.tahun})
                    </p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">No Polisi</label>
                    <p className="text-gray-900">{offer.mobil.noPol}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Harga Asli</label>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-900 mb-3">Analisis Penawaran</h4>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-600">{formatCurrency(offer.hargaTawaran)}</span>
                  </div>
                  <div className="flex justify-between border-t pt-2">
                    <span>Potensi Keuntungan:</span>
                    <span className="font-medium text-green-600">
                      {formatCurrency(offer.hargaTawaran * 0.8)} {/* Assume 80% cost */}
                    </span>
                  </div>
                  <div className="flex justify-between">
              ...
              {offer.status === 'pending' && (
                <div className="border border-orange-200 bg-orange-50 p-4 rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-semibold text-orange-900">Rekomendasi</h4>
                  </div>
            ...
            <div className="mt-6 pt-6 border-t">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    value={newStatus}
                    onChange={(e) => setNewStatus(e.target.value as 'accepted' | 'rejected')}
                ...
                <div className="flex gap-3">
                  <button
                    onClick={() => onUpdateStatus(offer.mobil._id, offer._id, 'rejected', notes)}
                  ...
                  <button
                    onClick={() => onUpdateStatus(offer.mobil._id, offer._id, 'accepted', notes)}
