...
export default function MobilSearchFilter({ initialFilters = {} }: MobilSearchFilterProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 px-6 py-4 mb-8 max-w-5xl mx-auto">
      <div className="flex flex-col md:flex-row items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="relative">
            <select
              ...
              className="w-full appearance-none bg-transparent border-none focus:outline-none text-gray-700 text-base font-medium cursor-pointer pr-8"
            >
          ...
          <div className="relative">
            ...
            >
              ...
              {transmisiOptions.map((transmisi) => (
                <option key={transmisi} value={transmisi}>{transmisi}</option>
              ))}
            </select>
            <svg className="absolute right-2 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
        ...
        <button
          ...
          className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-full font-medium transition-colors duration-200 flex items-center gap-2 whitespace-nowrap"
        >
      ...
      <div className="flex md:hidden flex-wrap gap-2 mt-4 pt-4 border-t border-gray-100 justify-center items-center">
        <button
