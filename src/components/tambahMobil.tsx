...
export default function TambahMobilPage({ onSuccess }: TambahMobilPageProps) {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!formData.fotos || formData.fotos.length < 6 || formData.fotos.length > 10) {
      setNotif({ message: 'Wajib upload minimal 6 foto dan maksimal 10 foto', type: 'error' });
      setIsSubmitting(false);
      return;
    }
    ...
    for (let i = 0; i < formData.fotos.length; i++) {
      const ext = formData.fotos[i].name.split('.').pop();
      const randomName = `${crypto.randomUUID()}.${ext}`;
      dataToSend.append('fotos', formData.fotos[i], randomName);
    }
    ...
    try {
      ...
      if (res.ok) {
        ...
        setNotif({ message: result.message || 'Gagal menambahkan mobil', type: 'error' });
      }
    } catch (err) {
  ...
  const inputClassName = "w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-lg";
  const selectClassName = "w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-lg appearance-none bg-white";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Tambah Mobil Baru</h1>
          <p className="text-xl text-gray-600">Lengkapi informasi mobil dengan detail yang akurat</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                ...
                <div className="relative">
                  <select name="merek" onChange={setFormData} className={selectClassName} required>
              ...
              <div>
                ...
                <div className="relative">
                  <select name="warna" onChange={setFormData} className={selectClassName} required>
              ...
              <div>
                ...
                <div className="relative">
                  <select name="bahan_bakar" onChange={setFormData} className={selectClassName} required>
              ...
              <div>
                ...
                <div className="relative">
                  <select name="transmisi" onChange={setFormData} className={selectClassName} required>
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 flex items-center">
              <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center text-white font-bold mr-3">3</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {['STNK', 'BPKB', 'Faktur'].map((name) => (
                <div key={name}>
                  ...
                  <div className="relative">
                    <select name={name} className={selectClassName} onChange={setFormData} required>
